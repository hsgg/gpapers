...
sqlite3_evolutions = [
    ...
    [('fv1:1757135243145264497','fv1:-1706681292196003501'), # generated 2009-01-21 16:46:58.949512
        "-- FYI: sqlite does not support adding primary keys or unique or not null fields",
        "-- FYI: so we create a new \"gPapers_playlist\" and delete the old ",
        "-- FYI: this could take a while if you have a lot of data",
        "ALTER TABLE \"gPapers_playlist\" RENAME TO \"gPapers_playlist_1337_TMP\";",
        "CREATE TABLE \"gPapers_playlist\" (\n    \"id\" integer NOT NULL PRIMARY KEY,\n    \"title\" varchar(1024) NOT NULL,\n    \"title2\" varchar(1024) NOT NULL,\n    \"search_text\" varchar(1024) NOT NULL,\n    \"parent\" varchar(1) NOT NULL,\n    \"created\" datetime NOT NULL,\n    \"updated\" datetime NOT NULL\n)\n;",
        "INSERT INTO \"gPapers_playlist\" SELECT \"id\",\"title\",'',\"search_text\",\"parent\",\"created\",\"updated\" FROM \"gPapers_playlist_1337_TMP\";",
        "DROP TABLE \"gPapers_playlist_1337_TMP\";",
    ],
    [('fv1:-1706681292196003501','fv1:1757135243145264497'), # generated 2009-01-21 17:10:59.653024
